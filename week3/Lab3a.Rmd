...
my_data %>%
    ...
    coord_flip() +
    labs(title = "Revenue by states", y = 'Total', x = 'State') +
    theme_classic() +
...
my_data %>%
    ...
    scale_x_discrete(expand = c(0.01,0)) +
    coord_flip() +
    labs(title = "Revenue by states", x = "State", y = "Total") +
    theme_classic() +
    theme(panel.background = element_rect(fill = "white", color = "white"),
          plot.title = element_text(face = "bold", hjust = 0.5),
          axis.text = element_text(size = 11, colour = "black"),
...
my_data %>%
    ...
    scale_y_continuous(labels = scales::dollar, expand = c(0.01, 0)) +
    coord_flip() +
    labs(title = "Revenue by Frame Size", x = "Frame Size", y = "Total Revenue") +
    theme_classic() +
    theme(panel.background = element_rect(fill = "white", color = "white"),
          plot.title = element_text(face = "bold", hjust = 0.5),
          axis.text = element_text(size = 11, colour = "black"),
...
my_data %>%
    ...
    scale_x_discrete(expand = c(0.01, 0)) +
    labs(title = "Revenue by Age Group", x = "Age Group", y = "Total") +
    theme_classic() +
    theme(panel.background = element_rect(fill = "white", color = "white"),
          plot.title = element_text(face = "bold", hjust = 0.5),
          axis.text = element_text(size = 11, colour = "black"),
