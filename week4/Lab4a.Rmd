...
ggplot(ans_2, aes(x = "", y = Prop, fill = reorder(Country, -Prop))) +
    ...
    geom_text(aes(x = c(1.0, 1.1, 1.2, 1.25, 1.25, 1.3), y = 1 - y_tick, label = Percent),
              size = 5) +
...
ggplot(ans_5, aes(x = "", y = Prop, fill = `Product Category`)) +
    ...
    geom_text(aes(x = c(1.2, .9, 1.3), y = 1 - y_tick, label = Percent), size = 5) +
    scale_fill_brewer(palette = "Set2") + #"Dark2"
    pie_theme
# TODO: increase size of labels in geom_text
```
